...
import {Text, View,FlatList,SafeAreaView,StyleSheet,StatusBar , Platform, Image,ImageBackground, Dimensions} from 'react-native';
...
export default class MeteorScreen extends Component{
    ...
    getMeteors=()=>{
        axios.get("https://api.nasa.gov/neo/rest/v1/feed?api_key=XhFgrpFmfYcZ8GRqyC7IKlxMJyMClnLKBLnyp5B7")
        .then(response=>{
            this.setState({
